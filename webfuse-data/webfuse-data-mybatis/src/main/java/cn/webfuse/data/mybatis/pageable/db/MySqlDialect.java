package cn.webfuse.data.mybatis.pageable.db;

import cn.webfuse.data.mybatis.pageable.Dialect;
import cn.webfuse.data.mybatis.pageable.PageRowBounds;
...
public class MySqlDialect implements Dialect {
    ...
    @Override
    public boolean skipPaging(String mappedStatementId, Object parameterObject, RowBounds rowBounds) {
    ...
    @Override
    public boolean willDoCount(String mappedStatementId, Object parameterObject, RowBounds rowBounds) {
    ...
    public void afterCount(long count, Object parameterObject, RowBounds rowBounds) {
        //记录总数，按照 willDoCount 逻辑，只有 PageRowBounds 时才会查询 count，所以这里直接强制转换
        ((PageRowBounds) rowBounds).setTotal(count);
    }

    @Override
    public boolean willDoPaging(String mappedStatementId, Object parameterObject, RowBounds rowBounds) {
        if (rowBounds != RowBounds.DEFAULT) {
            return true;
        }
        return false;
    ...
    @Override
    public Object afterPaging(List pageList, Object parameterObject, RowBounds rowBounds) {
        return pageList;
    }
