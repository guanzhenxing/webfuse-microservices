package cn.webfuse.data.mybatis.pageable;
...
public interface Dialect {
     ...
     * 跳过 count 和 分页查询
     *
     * @param mappedStatementId            执行的  MyBatis 方法全名
     * @param parameterObject 方法参数
     * @param rowBounds       分页参数
     * @return true 跳过，返回默认查询结果，false 执行分页查询
     */
    boolean skipPaging(String mappedStatementId, Object parameterObject, RowBounds rowBounds);

    /**
     * 执行分页前，返回 true 会进行 count 查询，false 会继续下面的 willDoPaging 判断
     *
     * @param mappedStatementId            执行的  MyBatis 方法全名
     * @param parameterObject 方法参数
     * @param rowBounds       分页参数
     * @return
     */
    boolean willDoCount(String mappedStatementId, Object parameterObject, RowBounds rowBounds);
     ...
     * @return
     */
    boolean willDoPaging(String mappedStatementId, Object parameterObject, RowBounds rowBounds);
     ...
     * @return
     */
    Object afterPaging(List pageList, Object parameterObject, RowBounds rowBounds);
