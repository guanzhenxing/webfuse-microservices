 ...
 */
public class DefaultSQLExceptionTranslator implements SQLExceptionTranslator {


    private static Logger log = LoggerFactory.getLogger(DefaultSQLExceptionTranslator.class);
