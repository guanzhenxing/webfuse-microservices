...
import network.swan.auth.service.ImageCode;
...
public class LoginController {
    ...
    @RequestMapping(value = "/images/image_code")
    public String createImageCode(HttpServletRequest request, HttpServletResponse response)
            throws Exception {
    ...
    @ResponseBody
    public String createCheckCode(HttpServletRequest request, HttpSession session)
            throws Exception {
