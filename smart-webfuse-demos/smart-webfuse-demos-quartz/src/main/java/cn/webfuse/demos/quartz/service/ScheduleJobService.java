package cn.webfuse.demos.quartz.service;

import cn.webfuse.demos.quartz.domain.ScheduleJob;
...
public class ScheduleJobService {
    ...
    public void getScheduleJob() {
        ...
        try {
            SchedulerFactoryBean schedulerFactoryBean = SpringContextHolder.getBean("scheduler");
