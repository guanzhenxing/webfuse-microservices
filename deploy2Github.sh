...
DEPLOY_PATH=/data/GitHub/maven-repository/
CURRENT_PATH=`pwd`
...
deployFunc(){
  ...
  cd $CURRENT_PATH
  # 开始deploy
  mvn clean deploy -Dmaven.test.skip  -DaltDeploymentRepository=self-mvn-repo::default::file:/data/GitHub/maven-repository/repository
