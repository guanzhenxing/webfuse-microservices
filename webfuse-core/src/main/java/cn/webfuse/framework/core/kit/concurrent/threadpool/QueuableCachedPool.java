...
public final class QueuableCachedPool extends ThreadPoolExecutor {
    ...
    public QueuableCachedPool(int corePoolSize, int maximumPoolSize, long keepAliveTime, TimeUnit unit,
    ...
    protected static class ControllableQueue extends LinkedBlockingQueue<Runnable> {
        ...
        private transient volatile QueuableCachedPool parent = null;

        public ControllableQueue(int capacity) {
            super(capacity);
        }

        public void setParent(QueuableCachedPool tp) {
            parent = tp;
        }
