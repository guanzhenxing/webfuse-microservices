...
public class ObjectIdGenerator {
     ...
     */
    private static AtomicInteger nextInc = new AtomicInteger(RandomUtils.nextInt());
    /**
     * 机器信息
     */
    ...
    private static int getMachinePiece() {
        ...
        try {
            ...
            // 出问题随机生成,保留后两位
            machinePiece = (RandomUtils.nextInt()) << 16;
        }
        return machinePiece;
    }
    ...
    private static int getProcessPiece() {
        ...
        try {
            ...
            processId = RandomUtils.nextInt();
        }

        final ClassLoader loader = ClassLoaderKits.getDefaultClassLoader();
