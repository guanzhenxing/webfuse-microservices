...
public class ThreadPoolBuilder {
    ...
    public static class QueuableCachedThreadPoolBuilder {
        ...
        public QueuableCachedPool build() {
            ...
            return new QueuableCachedPool(minSize, maxSize, keepAliveSecs, TimeUnit.SECONDS,
                    new QueuableCachedPool.ControllableQueue(queueSize), threadFactory, rejectHandler);
        }
    }
    ...
    private static ThreadFactory createThreadFactory(ThreadFactory threadFactory, String threadNamePrefix,
        ...
        if (threadNamePrefix != null) {
            if (daemon != null) {
                return ThreadPoolKits.buildThreadFactory(threadNamePrefix, daemon);
            } else {
                return ThreadPoolKits.buildThreadFactory(threadNamePrefix);
            }
        }
