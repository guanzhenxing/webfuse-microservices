...
import cn.webfuse.framework.core.exception.UncheckedException;
import cn.webfuse.framework.core.kit.ExceptionKits;
import cn.webfuse.framework.core.kit.ObjectKits;
 ...
 * 反射工具类.
 * <p>
 * copy from vipshop VJTools(com.vip.vjtools.vjkit.reflect.ReflectionUtil) and made some changes.
 */
@SuppressWarnings("unchecked")
public class ReflectionKits {
    ...
    public static <T> T invokeMethod(final Object obj, final String methodName, final Object[] args,
        ...
        if (method == null) {
            throw new IllegalArgumentException("Could not find method [" + methodName + "] with parameter types:"
                    + ObjectKits.toPrettyString(parameterTypes) + " on class [" + obj.getClass() + ']');
        }
    ...
    public static <T> T invokeMethod(final Object obj, Method method, Object... args) {
        try {
            ...
            throw ExceptionKits.unwrapAndUnchecked(e);
        }
    }
